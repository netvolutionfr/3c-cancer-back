...
export interface ApiActualiteActualite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Le flux d'actualit\u00E9s et le calendrier des \u00E9v\u00E9nements de l'association";
  ...
  attributes: {
    ...
    estEvenement: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Les contenus documentaires de l'application";
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    ongletParent: Schema.Attribute.Enumeration<
      ['Parcours', 'Mieux-vivre', 'Informations']
    > &
      Schema.Attribute.Required;
    ...
    sectionParente: Schema.Attribute.String;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Param\u00E8tres uniques de l'association (Contact, Adresse)";
  ...
  attributes: {
    adressePostale: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailContact: Schema.Attribute.Email;
    horaires: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    nomAssociation: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'3C des 3 Caps'>;
    publishedAt: Schema.Attribute.DateTime;
